...
order: 1
tags: []
sources: ["CLAUDE.md", "orchid/AGENTS.md", "orchid-api/AGENTS.md", "orchid-cli/AGENTS.md"]
...
*Sources: root `CLAUDE.md`, `orchid/AGENTS.md`, `orchid-api/AGENTS.md`, `orchid-cli/AGENTS.md`*
