...
Each MCP server declaration carries exactly one field under `auth:` — the `mode`. No credentials, no endpoints, no client IDs live in YAML.
...
<Sources files={["orchid/orchid_ai/mcp/client.py", "orchid/orchid_ai/mcp/AGENTS.md", "orchid/orchid_ai/config/schema_mcp.py", "orchid/AGENTS.md", "orchid-mcp/AGENTS.md"]} />
