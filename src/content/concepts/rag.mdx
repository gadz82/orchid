...
sources:
  ...
  - "orchid/orchid_ai/rag/backends/qdrant.py"
  - "orchid-cli/orchid_cli/rag/backends/chroma.py"
  - "orchid/orchid_ai/rag/AGENTS.md"
  - "orchid/AGENTS.md"
related: ["/concepts/embeddings", "/concepts/document-parsing", "/concepts/agents"]
example: "/examples/recipes"
external:
