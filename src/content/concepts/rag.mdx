...
<Callout variant="info" title="Local development with cli_rag">
...
The CLI automatically uses `cli_rag:` when present, falling back to `rag:` otherwise. See the [orchid-cli package page](/packages/orchid-cli) for details.
</Callout>
