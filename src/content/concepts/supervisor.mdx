...
All supervisor options live under the `supervisor:` key in `agents.yaml`:
...
<Sources files={["orchid/orchid_ai/graph/supervisor.py", "orchid/orchid_ai/config/schema_supervisor.py", "orchid/AGENTS.md"]} />
