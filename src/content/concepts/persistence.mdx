...
description: "OrchidChatStorage ABC, built-in PostgreSQL and SQLite backends, and pluggable custom backends."
package: "orchid"
section: "concepts"
order: 17
tags: []
...
<Sources files={["orchid/orchid_ai/persistence/base.py", "orchid/orchid_ai/persistence/AGENTS.md", "orchid/AGENTS.md"]} />
