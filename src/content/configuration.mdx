...
description: "Complete reference for orchid.yml + orchid.md and agents.yaml + agents/*.md: all sections, keys, defaults, and best practices."
package: "cross-cutting"
section: "configuration"
order: 30
tags: ["configuration", "yaml", "markdown", "reference"]
sources:
