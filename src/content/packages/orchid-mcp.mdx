...
<Sources files={["orchid-mcp/README.md", "orchid-mcp/AGENTS.md", "orchid-mcp/src/tools/registry.ts", "orchid-mcp/src/auth/base.ts", "orchid-mcp/src/sessions/base.ts", "orchid-mcp/src/http/orchidClient.ts"]} />
