...
export const navNodes: NavNode[] = [
  ...
  { href: '/examples/learning', label: 'Learning', group: 'examples', order: 44 },
  { href: '/examples/mcp-auth', label: 'MCP Auth', group: 'examples', order: 45 },
  { href: '/examples/custom-storage', label: 'Custom Storage', group: 'examples', order: 46 },
  { href: '/examples/rag-strategies', label: 'RAG Strategies', group: 'examples', order: 47 },
  { href: '/examples/tool-strategies', label: 'Tool Strategies', group: 'examples', order: 48 },
  { href: '/examples/prompt-customization', label: 'Prompt Customization', group: 'examples', order: 49 },
  { href: '/examples/graph-kb', label: 'Graph KB', group: 'examples', order: 50 },
  { href: '/examples/wiki', label: 'Wiki', group: 'examples', order: 51 },
