...
DEFAULT_REFORMULATE_PROMPT = (
    ...
    "RULES:\n"
    "- Detect if the user is changing the topic or continuing the previous conversation\n"
    "- If the user introduces a NEW topic (different subject matter), return their message UNCHANGED\n"
    "- ONLY resolve pronouns and references ('it', 'that', 'the first one', 'yes') when the user is clearly continuing the SAME topic\n"
