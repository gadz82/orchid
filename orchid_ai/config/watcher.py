...
:meth:`OrchidConfigWatcher.has_changes` (or the convenience
...
class OrchidConfigWatcher:
    ...
    def changed_files(self) -> list[str]:
        ...
        snapshot.  Excludes files that were deleted (they are reported
        via :meth:`has_changes` but not enumerated here — the caller
    ...
    def reload_if_changed(self) -> ConfigSnapshot | None:
    ...
    def reload(self) -> ConfigSnapshot:
        ...
        Always re-reads every file and rebuilds the configuration.
        """
    ...
    def reload_agent(self, name: str) -> ConfigSnapshot | None:
        ...
        new_config = deepcopy(self._snapshot.config)
